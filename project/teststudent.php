...
<body>
        <div>
            <br>
            <form method="post" action="teststudent.php">
          ...
          <label for="Gender"> Gender:</label>
    			...
    			<br><select name="Parent_id"> Parent Id:
				<?php        
				
				$sql = mysqli_query($link, "SELECT Parent_id, father_name FROM Parent");
				while ($row = $sql->fetch_assoc()){
				echo "<option value='{$row['Parent_id']}'>{$row['father_name']}</option>";
				}
...
$sql = "INSERT INTO Pupil (Parent_id,firstname,lastname,email,Gender) VALUES ('$Parent_id','$firstname','$lastname','$email','$Gender')";
